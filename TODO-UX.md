...
- [ ] si il y a au moins une photo en numérique, il faut un avertissement comme quoi l'email doit etre mis si ce n'est pas le cas, une fois qu'il est mis il faut déclencher l'export numérique pour rattraper
